...
export const ORDER_ORDER_LIST_REQUEST = 'ORDER_ORDER_LIST_REQUEST';
export const ORDER_ORDER_LIST_SUCCESS = 'ORDER_ORDER_LIST_SUCCESS';
export const ORDER_ORDER_LIST_FAIL = 'ORDER_ORDER_LIST_FAIL';